...
FHIR.oauth2.ready().then(function(client) {
  ...
  query.set("code", [
    ...
    'http://loinc.org|2514-8', // ketones in urine
  ...
  client.request("Observation?" + query, {
    ...
    function(ob) {
      ...
      let sys = byCodes('8480-6') ; // systolic blood pressure
      let dia = byCodes('8462-4'); // diastolic blood pressure
      ...
      let ketones = byCodes('2514-8') // ketones in urine
  ...
  //let medResults = ["SAMPLE Lasix 40mg","SAMPLE Naproxen sodium 220 MG Oral Tablet","SAMPLE Amoxicillin 250 MG"]
  // let medResults = [];
